...
<h2>You can support the Ministry by uploading files that are relaed to  {{ $data->name }} ethnic </h2>

<form action="{{url('/upload')}}" method="post" enctype="multipart/form-data">
    @csrf

    <div class="mb-3">
        <label for="file" class="form-label">Select file which are in (png, jpeg , docx, doc ,pdf) fromats only </label>
